...
class jQueryNotifyOptions extends jQuery_Notify {
	...
	/**
	 * jQueryNotifyOptions constructor.
	 */
	function __construct() {
		...
		$this->sections[ 'reset' ] = __('Reset to Default Options');
		$this->sections[ 'usage' ] = __('Usage');
		$this->sections[ 'about' ] = __('Support');
	...
	public function display_usage_section() {
		...
		<code>[jq_notify style=$style, speed=$speed, delay=$delay] Content [/jq_notify]</code>

		<p><strong>$style</strong> (optional): sets the style of the panel. Options are: <em>default</em>, <em>error</em>, <em>warning</em>, and <em>success</em><br />
		<strong>$speed</strong> (optional): time it takes (in milliseconds) for the panel to slide out.  Larger numbers = slower. Default: 1000ms<br />
		<strong>$delay</strong> (optional): delay (in milliseconds) between when the page has finished loading and when the panel slides out. Default: 500ms</p>

		<code>[jq_notify style="warning" speed=700 delay=1000]&lt;h2&gt;Notification Title&lt;/h2&gt;&lt;p&gt;Notification body content.&lt;/p&gt;[/jq_notify]</code>

		<h4>Template tag</h4>
		<code>jq_notify($content, $style, $speed, $delay, $close_button)</code>

		<code>jq_notify("&lt;h3&gt;This is the content&lt;/h3&gt;&lt;p&gt;And this is some more&lt;/p&gt;", "default", 2000, 500, TRUE);</code>';
	}
	...
	public function display_about_section() {
		echo '<p>Support development, consider <a href="https://mind.sh/are/donate/">making a donation</a>!</p>';
	}
